...
func (suite *CleanerSuite) TestCleaner(c *C) {
	flushConn := OpenConnection("cleaner-flush", "tcp", "192.168.99.100:6379", 1)
	flushConn.flushDb()
	flushConn.StopHeartbeat()

	conn := OpenConnection("cleaner-conn1", "tcp", "192.168.99.100:6379", 1)
	...
	cleanerConn := OpenConnection("cleaner-conn", "tcp", "192.168.99.100:6379", 1)
